    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionLogs", x => x.ConsultantId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdviceText = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Advices_Users_AdvisorId",
                        column: x => x.AdvisorId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Advices_Users_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    toAccount = table.Column<string>(type: "TEXT", nullable: true),
                    fromAccount = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transections", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_Transections_BankAccounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advices_AdvisorId",
                table: "Advices",
                column: "AdvisorId");

            migrationBuilder.CreateIndex(
                name: "IX_Advices_ClientId",
                table: "Advices",
                column: "ClientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transections_AccountId",
                table: "Transections",
                column: "AccountId");
